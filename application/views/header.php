    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?=base_url('index.php/inventory/dashboard')?>">Inventory Management System</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="dropdown-menu dropdown-alerts">
                        <li>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="pull-right text-muted small">4 minutes ago</span></br>
                                    <!-- <a href="<?=site_url('inventory/viewinventory')?>">
                                    <label for="form-control"> <? $this->post1->harvest() ?> </label>
                                    </a> -->
                                </div>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?=site_url('inventory/dashboard')?>"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
