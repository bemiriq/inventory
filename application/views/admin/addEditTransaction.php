                ...
                <div class="col-lg-6">
                    ...
                    <form name="frmOne" id="contactForm" class="form-horizontal" action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" value="<?php echo isset($post)?$post->customerName:''; ?>" name="transaction[customerName]" id="get_names_customer" placeholder="Enter customer full name">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" value="<?php echo isset($post)?$post->totalStockBuy:''; ?>" name="transaction[totalStockBuy]" id="totalStockBuy" placeholder="Enter stock bought number">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" value="<?php echo isset($post)?$post->cost:''; ?>" name="transaction[cost]" id="cost" placeholder="Enter cost per unit value">
                                </div>
                            </div>
